<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO guata (insumo, medida, id_proveedor, precio, unidades, fecha_actualizacion) 
        VALUES ('$insumo', '$medida', '$id_proveedor', '$precio', '$unidades', '$fecha_actualizacion')";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: guata.php");
        exit();
    }
    
    
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE guata SET insumo = '$insumo', medida = '$medida', id_proveedor = '$id_proveedor', precio = '$precio', unidades = '$unidades', fecha_actualizacion = NOW()
        WHERE id_guata = '$id_guata'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: guata.php");
        exit();
    }
    ...
    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM guata WHERE id_guata = '$id_guata'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: guata.php");
        exit();
    }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Tipos de Guata</h1>
            </div>
            <!-- DataTable -->
                ...
                <div class="card-body">
                    <d class="row">
                        ...
                        <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $consulta = "SELECT guata.id_guata, guata.insumo, guata.medida, guata.precio, proveedor.id_proveedor, proveedor.nombre, guata.unidades, guata.fecha_actualizacion     
                                FROM guata LEFT JOIN proveedor ON guata.id_proveedor = proveedor.id_proveedor WHERE guata.id_guata > 0
                                GROUP BY guata.id_guata";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_guata']; ?>">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_guata']; ?>">
                    ...
                    <?php
                        ...
                        ?>
                        <!-- Modal Editar -->
                        <div class="modal fade" id="modalEditar<?php echo $fila['id_guata']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content rounded-4">
                                    <div class="modal-header" style="background-color: #000DD3;">
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                        <input type="hidden" name="id_guata" value="<?php echo $fila['id_guata']; ?>">
                                            <div class="mb-3">
                                                <label class="form-label" style="color: #000000;">Ingrese el nombre del insumo:</label>
                        ...
                        <!-- Modal Eliminar -->                   
                        <div class="modal fade" id="modalEliminar<?php echo $fila['id_guata']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
