<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        if (mysqli_num_rows($resultado_verificar_nit) > 0) {
            ...
            header("Location: proveedor_tela.php?recibido=2");
            exit();
        }
    }
    ...
    if (isset($_POST['submit_calificar'])) {
        ...
        $consulta = "INSERT INTO califi_proveedortela (id_proveedor, id_calificacion, fecha, observaciones) VALUES ('$id_proveedor', '$id_calificacion', '$fecha', '$observaciones')";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: proveedor_tela.php");
        exit();
    }
                            ...
                            <div class="row">
                                                    ...
                                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" class="form-control" name="repre_comercial" placeholder="Ingrese el nombre" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" maxlength="10">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                ...
                                <div class="table-responsive">
                                    <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $consulta = "SELECT proveedor_tela.id_proveedor, proveedor_tela.nit, proveedor_tela.nombre, proveedor_tela.celular, proveedor_tela.email, proveedor_tela.banco, proveedor_tela.tipo_cuenta, proveedor_tela.num_cuenta, proveedor_tela.certificado_bancario, proveedor_tela.repre_comercial, 
                                            proveedor_tela.autorizacion, proveedor_tela.departamento, proveedor_tela.ciudad, proveedor_tela.direccion, proveedor_tela.descripcion, califi_proveedortela.id_registro, califi_proveedortela.fecha, califi_proveedortela.observaciones, calificacion.id_calificacion, calificacion.calificacion
                                            FROM proveedor_tela
                                            LEFT JOIN (SELECT id_proveedor, MAX(fecha) AS max_fecha FROM califi_proveedortela GROUP BY id_proveedor) AS ultima_calificacion ON proveedor_tela.id_proveedor = ultima_calificacion.id_proveedor
                                            LEFT JOIN califi_proveedortela ON proveedor_tela.id_proveedor = califi_proveedortela.id_proveedor AND califi_proveedortela.fecha = ultima_calificacion.max_fecha
                                            LEFT JOIN calificacion ON calificacion.id_calificacion  = califi_proveedortela.id_calificacion WHERE proveedor_tela.id_proveedor > 0
                                            ORDER BY proveedor_tela.nombre";
                                            ...
                                            ?>
                                                <tr>
                                                    <td class="text-center"><strong><?php echo $fila['nombre']; ?></strong><br><br>
                                                        ...
                                                        <?php if (!empty($fila['repre_comercial'])): ?>
                                                            <strong>Representante: </strong> <?php echo $fila['repre_comercial']; ?>
                                                        <?php endif; ?><br><br>
                                                        <center><button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalMostrar<?php echo $fila['id_proveedor']; ?>">
                                ...
                                ?>
                                    ...
                                    <div class="modal fade" id="modalRegistros<?php echo $fila['id_proveedor']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background-color: #000DD3;">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Calificaciones rrealizadas al proveedor</h5>
                                                    <button type="button" class="btn-close text-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <?php
                                                    $id_proveedor = $fila['id_proveedor']; // Obtener el id_proveedor del array $fila
                                                    $consulta2 = "SELECT califi_proveedortela.id_registro, califi_proveedortela.fecha, califi_proveedortela.observaciones, calificacion.id_calificacion, calificacion.calificacion, proveedor_tela.id_proveedor
                                                                FROM proveedor_tela
                                                                LEFT JOIN califi_proveedortela ON proveedor_tela.id_proveedor = califi_proveedortela.id_proveedor 
                                                                LEFT JOIN calificacion ON calificacion.id_calificacion  = califi_proveedortela.id_calificacion 
                                                                WHERE proveedor_tela.id_proveedor = $id_proveedor";
