<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $cant_corte = $_POST['cant_corte'];
        $tiempo_corte = $_POST['tiempo_corte'];
        
        // Utilizar NOW() para obtener la fecha y hora actuales
        $fecha_actualizacion = date('Y-m-d'); // Formatear la fecha
    
        $consulta = "INSERT INTO corte (cant_corte, tiempo_corte, fecha_actualizacion) 
        VALUES ('$cant_corte', '$tiempo_corte', '$fecha_actualizacion')";
    ...
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE corte SET cant_corte = '$cant_corte', tiempo_corte = '$tiempo_corte', fecha_actualizacion = NOW()
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilitiesTelas" class="collapse" aria-labelledby="headingUtilitiesITelas" data-parent="#accordionSidebar">
                        <div class="bg-white collapse-inner rounded">
                            ...
                            <?php
                                $consulta = "SELECT id_tipo_tela, tipo_tela FROM tipo_tela WHERE id_tipo_tela > 1";
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Tiempos de Corte</h1>
                    </div>
                    <!-- DataTable -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background-color: #000DD3;">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Ingrese el nuevo Tiempo de Corte</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                        <div class="mb-2 row">
                                                            <div class="col-sm-6">
                                                                <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el Rango de Corte:</label>
                                                                <div>
                                                                    <input type="text" class="form-control" name="cant_corte" placeholder="Ingresa el o los rangos de corte" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="45" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el Tiempo de Corte:</label>    
                                                                <div>
                                                                    <input type="number" class="form-control" name="tiempo_corte" placeholder="Ingrese el Tiempo de Corte" pattern="[0-9]+" step="0.01" minlength="1" maxlength="11" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th><center>Rangos de Corte</center></th>
                                            <th><center>Tiempo de corte</center></th>
                                    ...
                                    <tbody>
                                        <?php
                                        $consulta = "SELECT corte.id_corte, corte.cant_corte, corte.tiempo_corte, corte.fecha_actualizacion
                                        FROM corte WHERE corte.id_corte > 0";
                                        ...
                                        while ($fila = mysqli_fetch_array($resultado)) {
                                            ?>
                                            <tr>
                                                <td><center><?php echo $fila['cant_corte']; ?></center></td>
                                                <td><center><?php echo $fila['tiempo_corte']; ?></center></td>
                                                <td><center><?php echo $fila['fecha_actualizacion']; ?></center></td>
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_corte']; ?>">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_corte']; ?>">
                            ...
                            <?php
                                ...
                                ?>
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalEditar<?php echo $fila['id_corte']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header" style="background-color: #000DD3;">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                <input type="hidden" id="id_tela" name="id_corte" value="<?php echo $fila['id_corte']; ?>">
                                                    <div class="mb-2 row">
                                                        <div class="col-sm-6">
                                                        <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el Rango de Corte:</label>
                                                            <div>
                                                            <input type="text" class="form-control" name="cant_corte" value="<?php echo $fila['cant_corte']; ?>" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="45" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                        <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el Tiempo de Corte:</label>    
                                                            <div class="col-sm-2">
                                                                <input type="number" class="form-control" name="tiempo_corte" class="form-control" value="<?php echo $fila['tiempo_corte']; ?>" pattern="[0-9]+" step="0.01" minlength="1" maxlength="11" style="width: 200px;" required>
                                                            </div>
                                                        </div>
                                                    </div>                                        
                                                    <div class="modal-footer">
                                ...
                                <!-- Modal Eliminar -->                   
                                <div class="modal fade" id="modalEliminar<?php echo $fila['id_corte']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header text-white rounded-top" style="background-color: #000DD3;">
                                                <h5 class="modal-title" id="exampleModalLabel" style="color: white; text-align: center;">¿Realmente desea quitar el siguiente tiempo de corte: <?php echo $fila['cant_corte']; ?>?</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="alert alert-warning" role="alert">
                                                    Si continúa, el rango de corte sera eliminado de la base de datos.
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                    <input type="hidden" name="id_corte" value="<?php echo $fila['id_corte']; ?>">
