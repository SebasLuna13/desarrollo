<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        SELECT IFNULL(MAX(id_prenda), 0) + 1, '$nombre_prenda', '$promedio_consumo', '4'
        FROM prenda;";
        
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: prenda_infm.php");
        exit();
    }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Prendas Inferiores para Mujer</h1>
            </div>
            <!-- DataTable -->
                    ...
                    <d class="row">
                        ...
                        <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                WHERE prenda.id_tipo_prenda = 4 ORDER BY prenda.id_prenda";
