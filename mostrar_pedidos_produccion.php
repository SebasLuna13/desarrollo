<?php
    ...
    if (isset($_POST['submit_finalizar'])) {
        // Obtén la fecha y hora actual en formato MySQL
        $fecha_actual = date("Y-m-d H:i:s");
        $consulta = "UPDATE producto SET fecha_finalizado = '$fecha_actual', estado = 'Completado' WHERE id_producto = '$id_producto'";
        $resultado = mysqli_query($enlace, $consulta);

        header("Location: mostrar_pedidos_produccion.php?id_pedido=" . $id_pedido);
        exit();
    } 
?>
...
<body>
    ...
    <?php
        $consulta = "SELECT 
        producto.id_producto, producto.precio_venta, producto.precio_iva, producto.cant_tallas, producto.cant_prendas, producto.suma_prendas, producto.imagen, producto.precio_total, producto.estado,
        ...
        producto.nombre_proveedor, producto.precio_compra, producto.observaciones, producto.valor_agregado
        FROM producto
        ...
        LEFT JOIN entrega ON producto.id_entrega = entrega.id_entrega WHERE pedido.id_pedido = $id_pedido AND producto.estado IS NULL";
                    ...
                    <div class="modal-content rounded-4 modal-fullscreen">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-1 mt-1 text-center border rounded p-1">
                                <h6 class="text-muted font-weight-bold bg-light p-1 rounded">Informacion Basica</h6>
                                <div class="row">
                                    <div class="col-md-6">
