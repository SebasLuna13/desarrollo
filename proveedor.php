                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $consulta = "SELECT proveedor.id_proveedor, proveedor.nit, proveedor.nombre, proveedor.celular, proveedor.email, proveedor.banco, proveedor.tipo_cuenta, proveedor.num_cuenta, proveedor.certificado_bancario, proveedor.repre_comercial, 
