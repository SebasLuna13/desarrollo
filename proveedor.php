<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO proveedor (nit, nombre, celular, repre_comercial, email, banco, tipo_cuenta, num_cuenta, certificado_bancario, autorizacion, departamento, ciudad, direccion, descripcion) 
    ...
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE proveedor SET nombre = '$nombre', celular = '$celular', repre_comercial = '$repre_comercial', email = '$email', banco = '$banco', tipo_cuenta = '$tipo_cuenta', num_cuenta = '$num_cuenta', autorizacion = '$autorizacion', departamento = '$departamento', ciudad = '$ciudad', direccion = '$direccion', descripcion = '$descripcion' 
    ...
    if (isset($_POST['submit_calificar'])) {
        ...
        $consulta = "UPDATE proveedor SET id_calificacion = '$id_calificacion', observaciones = '$observaciones' WHERE id_proveedor = '$id_proveedor'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: proveedor.php");
        exit();
    }
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $consulta = "SELECT proveedor.id_proveedor, proveedor.nit, proveedor.nombre, proveedor.celular, proveedor.email, proveedor.banco, proveedor.tipo_cuenta, proveedor.num_cuenta, 
                                proveedor.departamento, proveedor.ciudad, proveedor.direccion, proveedor.descripcion, calificacion.id_calificacion, calificacion.calificacion, proveedor.observaciones, 
                                proveedor.certificado_bancario, proveedor.repre_comercial, proveedor.autorizacion
                                            FROM proveedor
                                            LEFT JOIN calificacion ON proveedor.id_calificacion = calificacion.id_calificacion 
