                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th style="text-align: center; vertical-align: middle; width: 10%;">Codigo del Pedido</th>
                                    ...
                                    <tbody>
                                        <?php
                                            $consulta = "SELECT pedido.id_pedido, pedido.nit, pedido.cod_orden_compra, cliente.cliente, pedido.total_factura, pedido.fecha_pedido 
                                        ...
                                        while ($fila = mysqli_fetch_array($resultado)) {
                                            ?>
                                            <tr>
                                                <td class="text-center align-middle"><?php echo $fila['cod_orden_compra']; ?></td>
                                                ...
                                                <td class="text-center align-middle">
                                                    <div>
                                                        <a class="btn btn-info btn-block mb-2" href="mostrar_finalizados_comercial.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>">
