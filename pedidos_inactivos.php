            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Cotizaciones Eliminadas</h1><br>
                    </div>
                    <!-- DataTable -->
                    ...
                    <div class="container-fluid">
                        ...
                        <thead>
                            <tr>
                                ...
                                <!--<th><center>Fecha de Entrega <br> del Pedido</center></th>
                                <th><center>Valor del anticipo</center></th>-->
                                <th style="text-align: center; vertical-align: middle;" ><center>Fecha <br>Realización Pedido</center></th>
                                <th style="text-align: center; vertical-align: middle; width: 11%;"><center>Opciones</center></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                ...
                                pedido.fecha_entrega1, pedido.fecha_entrega2, pedido.fecha_entrega3, pedido.total_factura FROM pedido LEFT JOIN cliente ON pedido.nit = cliente.nit WHERE pedido.estado = 'Inactivo' ORDER BY pedido.id_pedido DESC";
                            ...
                            while ($fila = mysqli_fetch_array($resultado)) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <div>
                                            <a class="btn btn-info btn-block mb-2" href="mostrar_pedidos_inactivos.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>&recibido=0">
                                ...
                                <div class="modal fade" id="modalPedido<?php echo $fila['id_pedido']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content rounded-4">
                                            ...
                                            <div class="modal-body">
                                                <div class="alert alert-warning" role="alert">
                                                    Si continua el pedido volvera a estar en estado de Espera y se podra ver desde el apartado de cotizaciones.
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                    <input type="hidden" name="id_pedido" value="<?php echo $fila['id_pedido']; ?>">
                                                    <button type="submit" name="submit_espera" class="btn btn-danger">Continuar</button>
                                                </form>
