    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Cotizaciones Eliminadas</h1>
            </div>
            <!-- DataTable -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a class="btn btn-info me-2" href="mostrar_pedidos_inactivos.php?id_pedido=<?php echo $fila['id_pedido']; ?>&recibido=0">
                                                    <i class="bi bi-search"></i>
                                                </a>
                                                <button type="button" class="btn btn-warning me" data-bs-toggle="modal" data-bs-target="#modalPedido<?php echo $fila['id_pedido']; ?>">
