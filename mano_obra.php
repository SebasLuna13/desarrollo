            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Valor Mano de Obra por Producto</h1>
                    </div>
                    <!-- DataTable -->
                    <div class="container-fluid">
                        <div class="card-body">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background-color: #000DD3;">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Ingrese los Datos</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                        <div class="mb-2 row">
                                                            <div class="col-sm-6">
                                                                <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el nombre de la prenda:</label>
                                                                <div>
                                                                    <input type="text" class="form-control" name="producto" placeholder="Ingresa el tipo de prenda" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="45" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el precio de confeccion de la prenda:</label>    
                                                                <div>
                                                                    <input type="number" class="form-control" name="precio_confeccion" placeholder="Ingrese el precio" pattern="[0-9]+" step="0.01" minlength="1" maxlength="11" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center>Precio de confeccion</center></th>
                                    ...
                                    <tbody>
                                        <?php
                                        $consulta = "SELECT mano_obra.id_mano_obra, mano_obra.producto, mano_obra.precio_confeccion, mano_obra.fecha_actualizacion
                                        FROM mano_obra WHERE mano_obra.id_mano_obra > 0";
                                        ...
                                        while ($fila = mysqli_fetch_array($resultado)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><center><?php $precio = $fila['precio_confeccion']; $precio_formateado = $precio == intval($precio) ? number_format($precio, 0, ',', '.') : number_format($precio, 2, ',', '.');?>$<?= $precio_formateado ?></center></td>
                                                <td><center><?php echo $fila['fecha_actualizacion']; ?></center></td>
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_mano_obra']; ?>">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_mano_obra']; ?>">
                            ...
                            <?php
                                ...
                                ?>
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalEditar<?php echo $fila['id_mano_obra']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header" style="background-color: #000DD3;">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                <input type="hidden" id="id_tela" name="id_mano_obra" value="<?php echo $fila['id_mano_obra']; ?>">
                                                    <div class="mb-2 row">
                                                        <div class="col-sm-6">
                                                        <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el nombre de la prenda:</label>
                                                            <div>
                                                            <input type="text" class="form-control" name="producto" value="<?php echo $fila['producto']; ?>" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="45" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                        <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el precio de confeccion de la prenda:</label>    
                                                            <div class="col-sm-2">
                                                                <input type="number" class="form-control" name="precio_confeccion" class="form-control" value="<?php echo $fila['precio_confeccion']; ?>" pattern="[0-9]+" step="0.01" minlength="1" maxlength="11" style="width: 200px;" required>
                                                            </div>
                                                        </div>
                                                    </div>                                        
                                                    <div class="modal-footer">
                                ...
                                <!-- Modal Eliminar -->                   
                                <div class="modal fade" id="modalEliminar<?php echo $fila['id_mano_obra']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header text-white rounded-top" style="background-color: #000DD3;">
                                                <h5 class="modal-title" id="exampleModalLabel" style="color: white; text-align: center;">¿Realmente desea quitar el precio de confeccion de la prenda: <?php echo $fila['producto']; ?>?</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="alert alert-warning" role="alert">
                                                    Si continúa, el precio de confeccion sera eliminado de la base de datos.
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                    <input type="hidden" name="id_mano_obra" value="<?php echo $fila['id_mano_obra']; ?>">
