<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO entretela (insumo, medida, id_proveedor, precio, unidades, fecha_actualizacion) 
        VALUES ('$insumo', '$medida', '$id_proveedor', '$precio', '$unidades', '$fecha_actualizacion')";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: entretela.php");
        exit();
    }
    
    
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE entretela SET insumo = '$insumo', medida = '$medida', id_proveedor = '$id_proveedor', precio = '$precio', unidades = '$unidades', fecha_actualizacion = NOW()
        WHERE id_entretela = '$id_entretela'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: entretela.php");
        exit();
    }
    ...
    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM entretela WHERE id_entretela = '$id_entretela'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: entretela.php");
        exit();
    }
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Tipos de Entretelas</h1>
                    </div>
                    <!-- DataTable -->
                        ...
                        <div class="card-body">
                            <d class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background-color: #000DD3;">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Ingresa los datos de la entretela</h5>
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $consulta = "SELECT entretela.id_entretela, entretela.insumo, entretela.medida, entretela.precio, 
                                        proveedor.id_proveedor, proveedor.nombre, entretela.unidades, entretela.fecha_actualizacion
                                        FROM entretela
                                        LEFT JOIN proveedor ON entretela.id_proveedor = proveedor.id_proveedor
                                        WHERE entretela.id_entretela > 0
                                        ORDER BY entretela.id_entretela";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_entretela']; ?>">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_entretela']; ?>">
                            ...
                            <?php
                                ...
                                ?>
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalEditar<?php echo $fila['id_entretela']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header" style="background-color: #000DD3;">
                                ...
                                <!-- Modal Eliminar -->                   
                                <div class="modal fade" id="modalEliminar<?php echo $fila['id_entretela']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
