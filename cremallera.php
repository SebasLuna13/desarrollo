<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO cremallera (insumo, medida, id_proveedor, precio, unidades, fecha_actualizacion) 
        VALUES ('$insumo', '$medida', '$id_proveedor', '$precio', '$unidades', '$fecha_actualizacion')";

        $consulta2 = "INSERT INTO cremallera2 (insumo, medida, id_proveedor, precio, unidades, fecha_actualizacion) 
        VALUES ('$insumo', '$medida', '$id_proveedor', '$precio', '$unidades', '$fecha_actualizacion')";

        $resultado = mysqli_query($enlace, $consulta);
        $resultado2 = mysqli_query($enlace, $consulta2);

        header("Location: cremallera.php");
        exit();
    }
    ...
    if (isset($_POST['submit_editar'])) {
        ...
        $consulta = "UPDATE cremallera SET insumo = '$insumo', medida = '$medida', id_proveedor = '$id_proveedor', precio = '$precio', unidades = '$unidades', fecha_actualizacion = NOW()
        WHERE id_cremallera = '$id_cremallera'";

        $consulta2 = "UPDATE cremallera2 SET insumo = '$insumo', medida = '$medida', id_proveedor = '$id_proveedor', precio = '$precio', unidades = '$unidades', fecha_actualizacion = NOW()
        WHERE id_cremallera2 = '$id_cremallera'";
    ...
    if (isset($_POST['submit_eliminar'])) {
        ...
        $consulta = "DELETE FROM cremallera WHERE id_cremallera = '$id_cremallera'";
        $consulta2 = "DELETE FROM cremallera2 WHERE id_cremallera2 = '$id_cremallera'";
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Tipos de Cremallera</h1>
                    </div>
                    <!-- DataTable -->
                        ...
                        <div class="card-body">
                            <d class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background-color: #000DD3;">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Ingresa datos de la Cremallera</h5>
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $consulta = "SELECT cremallera.id_cremallera, cremallera.insumo, cremallera.medida, cremallera.precio, 
                                        proveedor.id_proveedor, proveedor.nombre, cremallera.unidades, cremallera.fecha_actualizacion
                                        FROM cremallera
                                        LEFT JOIN proveedor ON cremallera.id_proveedor = proveedor.id_proveedor
                                        WHERE cremallera.id_cremallera > 0
                                        ORDER BY cremallera.id_cremallera";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_cremallera']; ?>">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_cremallera']; ?>">
                            ...
                            <?php
                                ...
                                ?>
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalEditar<?php echo $fila['id_cremallera']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header" style="background-color: #000DD3;">
                                ...
                                <!-- Modal Eliminar -->                   
                                <div class="modal fade" id="modalEliminar<?php echo $fila['id_cremallera']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
