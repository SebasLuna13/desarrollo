<?php
    ...
    if (isset($_POST['editar'])) {
        ...
        $consulta .= "UPDATE logistica SET precio = '$precio' WHERE id_logistica = '$id_logistica'; ";
                                ...
                                <div class="row">
                                    <div class="col" style="border-right: 1px solid #ccc;">
                                        ...
                                        <div class="mb-3 d-flex align-items-center justify-content-center">
                                            ...
                                            <div style="display: flex; align-items: center;">
                                                <input type="number" step="any" class="form-control" name="precio" class="form-control" value="<?php echo $fila['precio']; ?>" pattern="[0-9]+(\.[0-9]+)?" style="width: 100px;" min="0" oninput="validarNumero(this)" onwheel="deshabilitarScroll(event)" required>
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="col">
