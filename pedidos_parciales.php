            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Pedidos Finalizados</h1><br>
                    </div>
                    <!-- DataTable -->
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center; vertical-align: middle;">Valor Factura</th>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            pedido.fecha_entrega1, pedido.fecha_entrega2, pedido.fecha_entrega3, pedido.total_factura FROM pedido LEFT JOIN cliente ON pedido.nit = cliente.nit WHERE pedido.estado = 'Pedido' ORDER BY pedido.id_pedido DESC";
                                        ...
                                        while ($fila = mysqli_fetch_array($resultado)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <div>
                                                        <a class="btn btn-info btn-block mb-2" href="mostrar_pedidos_parciales.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>&recibido=0">
