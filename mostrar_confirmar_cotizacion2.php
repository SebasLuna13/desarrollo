<?php
    ...
    if (isset($_POST['guardar'])) {
        ...
        $observaciones_comercial = isset($_POST['observaciones_comercial']) ? $_POST['observaciones_comercial'] : null; 
        if ($id_producto && $observaciones_comercial !== null) {
            $consulta = "UPDATE producto SET observaciones_comercial = '$observaciones_comercial' WHERE id_producto = '$id_producto'";
            $resultado = mysqli_query($enlace, $consulta);
            header("Location: mostrar_confirmar_cotizacion2.php?id_pedido=$id_pedido&recibido=$recibido");
            exit();
        }
    }

    if (isset($_POST['aceptar_cotizacion'])) {
        $consulta = "UPDATE pedido SET estado = 'Confirmado' WHERE id_pedido = '$id_pedido'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: confirmar_cotizacion2.php");
        exit();
    }
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg" style="background-color: #000DD3;">
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <a href="confirmar_cotizacion2.php" class="btn btn-primary" style="margin-left: 10px;"><i class="bi bi-arrow-bar-left"></i> Volver</a>
            </div>
        </nav>

        <div class="text-center mt-3">
            <h1 style="font-family: 'Times New Roman'">Observaciones de la Cotizacion</h1>
        ...
        <div class="text-center">
            <button type="button" class="btn btn-success mx-3" data-bs-toggle="modal" data-bs-target="#modalAceptar<?php echo $fila['id_pedido']; ?>">
                <i class="bi bi-check2-all"></i> Aceptar la Cotizacion
            </button>
            <button type="button" class="btn btn-danger mx-3" data-bs-toggle="modal" data-bs-target="#modalRechazar<?php echo $fila['id_pedido']; ?>">
                <i class="bi bi-x-octagon-fill"></i> Rechazar la Cotizacion
            </button>
        </div><br>
                        ...
                        <div class="modal-content rounded-4 modal-fullscreen">
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-1 mt-1 text-center border rounded p-1">
                                        <h6 class="text-muted font-weight-bold bg-light p-1 rounded">Ingrese sus Observaciones</h6>
                                        <textarea class="form-control" name="observaciones_comercial" placeholder="Ingresa una descripción" pattern="[A-Za-z-Zñóéí ]+" maxlength="1000" rows="8"><?= $fila['observaciones_comercial']; ?></textarea>
                                        <div class="mb-1 mt-1 p-1 modal-footer">
