<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO bolsa (insumo, medida, id_proveedor, precio, unidades, fecha_actualizacion) 
    ...
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE bolsa SET insumo = '$insumo', medida = '$medida', id_proveedor = '$id_proveedor', precio = '$precio', unidades = '$unidades', fecha_actualizacion = NOW()
    ...
    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM bolsa WHERE id_bolsa = '$id_bolsa'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: bolsa.php");
        exit();
    }
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Tipos de Bolsas</h1>
                    </div>
                    <!-- DataTable -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background-color: #000DD3;">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Ingresa datos del Bolsa</h5>
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $consulta = "SELECT bolsa.id_bolsa, bolsa.insumo, bolsa.medida, bolsa.precio, 
                                        proveedor.id_proveedor, proveedor.nombre, bolsa.unidades, bolsa.fecha_actualizacion
                                        FROM bolsa
                                        LEFT JOIN proveedor ON bolsa.id_proveedor = proveedor.id_proveedor
                                        WHERE bolsa.id_bolsa > 0
                                        ORDER BY bolsa.id_bolsa";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_bolsa']; ?>">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_bolsa']; ?>">
                            ...
                            <?php
                                ...
                                ?>
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalEditar<?php echo $fila['id_bolsa']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header" style="background-color: #000DD3;">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                <input type="hidden" id="id_tela" name="id_bolsa" value="<?php echo $fila['id_bolsa']; ?>">
                                                    <div class="mb-3">
                                                        <label class="form-label" style="color: #000000;">Ingrese el nombre del insumo:</label>
                                ...
                                <!-- Modal Eliminar -->                   
                                <div class="modal fade" id="modalEliminar<?php echo $fila['id_bolsa']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content rounded-4">
                                            ...
                                            <div class="modal-footer">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                    <input type="hidden" name="id_bolsa" value="<?php echo $fila['id_bolsa']; ?>">
