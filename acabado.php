<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO acabado (insumo, precio, fecha_actualizacion) 
        VALUES ('$insumo', '$precio', '$fecha_actualizacion')";
        
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: acabado.php");
        exit();
    }
    
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE acabado SET insumo = '$insumo', precio = '$precio', fecha_actualizacion = NOW()
    ...
    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM acabado WHERE id_acabado = '$id_acabado'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: acabado.php");
        exit();
    }
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Tipos de Acabado</h1>
                    </div>
                    <!-- DataTable -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background-color: #000DD3;">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Ingresa datos del tipo de Acabado</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                        <div class="mb-2 row">
                                                            <div class="col-sm-6">
                                                                <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el tipo de acabado:</label>
                                                                <div>
                                                                    <input type="text" class="form-control" name="insumo" placeholder="Ingresa el Nombre" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="45" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el precio:</label>    
                                                                <div>
                                                                    <input type="number" class="form-control" name="precio" placeholder="Ingrese el Precio " pattern="[0-9]+" minlength="1" maxlength="11" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $consulta = "SELECT acabado.id_acabado, acabado.insumo, acabado.precio, acabado.fecha_actualizacion
                                        FROM acabado WHERE acabado.id_acabado > 0";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_acabado']; ?>">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_acabado']; ?>">
                            ...
                            <?php
                                ...
                                ?>
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalEditar<?php echo $fila['id_acabado']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header" style="background-color: #000DD3;">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                <input type="hidden" id="id_tela" name="id_acabado" value="<?php echo $fila['id_acabado']; ?>">
                                                    <div class="mb-2 row">
                                                        <div class="col-sm-6">
                                                        <label class="form-label" style="color: #000000;">Ingrese el Tipo de Acabado:</label>
                                                            <div>
                                ...
                                <!-- Modal Eliminar -->                   
                                <div class="modal fade" id="modalEliminar<?php echo $fila['id_acabado']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content rounded-4">
                                            ...
                                            <div class="modal-footer">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                    <input type="hidden" name="id_acabado" value="<?php echo $fila['id_acabado']; ?>">
