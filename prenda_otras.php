<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO prenda (id_prenda, nombre_prenda, promedio_consumo, id_caracteristica)
        SELECT IFNULL(MAX(id_prenda), 0) + 1, '$nombre_prenda', '$promedio_consumo', '7'
        FROM prenda;";
        
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: prenda_otras.php");
        exit();
    }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Otro Tipo de Prendas</h1>
            </div>
            <!-- DataTable -->
                    ...
                    <d class="row">
                        ...
                        <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                WHERE prenda.id_tipo_prenda = 7 ORDER BY prenda.id_prenda";
