<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO trabilla (insumo, medida, id_proveedor, precio, unidades, fecha_actualizacion) 
        VALUES ('$insumo', '$medida', '$id_proveedor', '$precio', '$unidades', '$fecha_actualizacion')";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: trabilla.php");
        exit();
    }
    
    
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE trabilla SET insumo = '$insumo', medida = '$medida', id_proveedor = '$id_proveedor', precio = '$precio', unidades = '$unidades', fecha_actualizacion = NOW()
        WHERE id_trabilla = '$id_trabilla'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: trabilla.php");
        exit();
    }
    ...
    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM trabilla WHERE id_trabilla = '$id_trabilla'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: trabilla.php");
        exit();
    }
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Tipos de Trabilla</h1>
                    </div>
                    <!-- DataTable -->
                        ...
                        <div class="card-body">
                            <d class="row">
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $consulta = "SELECT trabilla.id_trabilla, trabilla.insumo, trabilla.medida, trabilla.precio, proveedor.id_proveedor, proveedor.nombre, trabilla.unidades, trabilla.fecha_actualizacion
                                        FROM trabilla LEFT JOIN proveedor ON trabilla.id_proveedor = proveedor.id_proveedor WHERE trabilla.id_trabilla > 0
                                        ORDER BY trabilla.id_trabilla";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_trabilla']; ?>">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_trabilla']; ?>">
                            ...
                            <?php
                                ...
                                ?>
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalEditar<?php echo $fila['id_trabilla']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header" style="background-color: #000DD3;">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                <input type="hidden" name="id_trabilla" value="<?php echo $fila['id_trabilla']; ?>">
                                                <div class="mb-3">
                                                        <label class="form-label" style="color: #000000;">Ingrese el nombre del insumo:</label>
                                ...
                                <!-- Modal Eliminar -->                   
                                <div class="modal fade" id="modalEliminar<?php echo $fila['id_trabilla']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
