<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $tipo_estampado = $_POST['tipo_estampado'];
        $precio_estampado = $_POST['precio_estampado'];
        
        // Utilizar NOW() para obtener la fecha y hora actuales
        $fecha_actualizacion = date('Y-m-d'); // Formatear la fecha
    
        $consulta = "INSERT INTO estampado (tipo_estampado, precio_estampado, fecha_actualizacion) 
        VALUES ('$tipo_estampado', '$precio_estampado', '$fecha_actualizacion')";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: estampado.php");
        exit();
    }
    
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE estampado SET tipo_estampado = '$tipo_estampado', precio_estampado = '$precio_estampado', fecha_actualizacion = NOW()
        WHERE id_estampado = '$id_estampado'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: estampado.php");
        exit();
    }
    ...
    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM estampado WHERE id_estampado = '$id_estampado'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: estampado.php");
        exit();
    }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Tipos de Estampados</h1>
            </div>
            <!-- DataTable -->
                ...
                <div class="card-body">
                    <d class="row">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content rounded-4">
                                        <div class="modal-header" style="background-color: #000DD3;">
                                            <h5 class="modal-title text-white" id="exampleModalLabel">Ingresa los datos del Estampado</h5>
                                        ...
                                        <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tipo_estampado" placeholder="Ingresa el Nombre del Insumo" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="100" required>
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label" style="color: #000000;">Ingrese el precio del insumo:</label>
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="precio_estampado" placeholder="Ingrese el Precio" pattern="[0-9]+" minlength="1" maxlength="11" required>
                                                </div>
                                            </div>
                        ...
                        <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th><center>Tipo de Estampado</center></th>
                            ...
                            <tbody>
                                <?php
                                $consulta = "SELECT estampado.id_estampado, estampado.tipo_estampado, estampado.precio_estampado, estampado.fecha_actualizacion FROM estampado WHERE estampado.id_estampado > 0 ORDER BY estampado.id_estampado";
                                ...
                                while ($fila = mysqli_fetch_array($resultado)) {
                                    ?>
                                    <tr>
                                        <td><center><?php echo $fila['tipo_estampado']; ?></center></td>
                                        <td><center>$ <?php echo $fila['precio_estampado']; ?></center></td>
                                        <td><center><?php echo $fila['fecha_actualizacion']; ?></center></td>
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_estampado']; ?>">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_estampado']; ?>">
                    ...
                    <?php
                        ...
                        ?>
                        <!-- Modal Editar -->
                        <div class="modal fade" id="modalEditar<?php echo $fila['id_estampado']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content rounded-4">
                                    <div class="modal-header" style="background-color: #000DD3;">
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                            <input type="hidden" name="id_estampado" value="<?php echo $fila['id_estampado']; ?>">
                                            <div class="mb-3">
                                                <label class="form-label" style="color: #000000;">Ingrese el nombre del insumo:</label>
                                                <input type="text" class="form-control" name="tipo_estampado" value="<?php echo $fila['tipo_estampado']; ?>" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="100" required>
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label" style="color: #000000;">Ingrese el precio del insumo:</label>
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="precio_estampado" value="<?php echo $fila['precio_estampado']; ?>" pattern="[0-9]+" minlength="1" maxlength="11" required>
                                                </div>
                                            </div>
                        ...
                        <!-- Modal Eliminar -->                   
                        <div class="modal fade" id="modalEliminar<?php echo $fila['id_estampado']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content rounded-4">
                                    <div class="modal-header text-white rounded-top" style="background-color: #000DD3;">
                                        <h5 class="modal-title" id="exampleModalLabel" style="color: white; text-align: center;">¿Realmente desea eliminar el estampado: <?php echo $fila['tipo_estampado']; ?>?</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="alert alert-warning" role="alert">
