                                    ...
                                    <tbody>
                                        ...
                                        while ($fila = mysqli_fetch_array($resultado)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <div>
                                                        <a class="btn btn-info btn-block mb-2" href="pedido_para_enviarC.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>&id_entrega=<?php echo $fila['id_entrega']; ?>&recibido=0">
