<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO velcro (insumo, medida, id_proveedor, precio, unidades, fecha_actualizacion) 
        VALUES ('$insumo', '$medida', '$id_proveedor', '$precio', '$unidades', '$fecha_actualizacion')";
        
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: velcro.php");
        exit();
    }
    
    
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE velcro SET insumo = '$insumo', medida = '$medida', id_proveedor = '$id_proveedor', precio = '$precio', unidades = '$unidades', fecha_actualizacion = NOW()
        WHERE id_velcro = '$id_velcro'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: velcro.php");
        exit();
    }
    ...
    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM velcro WHERE id_velcro = '$id_velcro'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: velcro.php");
        exit();
    }
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Tipos de Velcro</h1>
                    </div>
                    <!-- DataTable -->
                        ...
                        <div class="card-body">
                            <d class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background-color: #000DD3;">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Ingresa los datos del Velcro</h5>
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $consulta = "SELECT velcro.id_velcro, velcro.insumo, velcro.medida, velcro.precio, 
                                        proveedor.id_proveedor, proveedor.nombre, velcro.unidades, velcro.fecha_actualizacion
                                        FROM velcro
                                        LEFT JOIN proveedor ON velcro.id_proveedor = proveedor.id_proveedor
                                        WHERE velcro.id_velcro > 0
                                        ORDER BY velcro.id_velcro";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_velcro']; ?>">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_velcro']; ?>">
                            ...
                            <?php
                                ...
                                ?>
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalEditar<?php echo $fila['id_velcro']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header" style="background-color: #000DD3;">
                                            ...
                                            <div class="modal-body">
                                                <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                <input type="hidden" name="id_velcro" value="<?php echo $fila['id_velcro']; ?>">
                                                <div class="mb-3">
                                                        <label class="form-label" style="color: #000000;">Ingrese el nombre del insumo:</label>
                                ...
                                <!-- Modal Eliminar -->                   
                                <div class="modal fade" id="modalEliminar<?php echo $fila['id_velcro']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
