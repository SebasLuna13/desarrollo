<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $rangos_margen = $_POST['rangos_margen'];
        ...
        $consulta = "INSERT INTO margen (rangos_margen, porcentaje, fecha_actualizacion) 
        VALUES ('$rangos_margen', '$porcentaje', '$fecha_actualizacion')";
        
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: margen.php");
        exit();
    }

    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM margen WHERE id_margen = '$id_margen'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: margen.php");
        exit();
    }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Rangos de Margen</h1>
            </div>
            <!-- DataTable -->
                ...
                <div class="card-body">
                    <div class="row">
                                    ...
                                    <div class="modal-content rounded-4">
                                        ...
                                        <div class="modal-body">
                                            <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    <label class="form-label" style="color: #000000;">Ingrese el rango del margen unidades y el porcentaje:</label>
                                                    <input type="text" class="form-control" name="rangos_margen" placeholder="Ingrese el rango" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ\-]+" minlength="3" maxlength="45" required>
                                                </div>
                                                <div style="display: flex; align-items: center;">
                                                    <label class="form-label" style="color: #000000; margin-right: 10px;">Ingrese el porcentaje sin %:</label>   
                                                    <input type="number" class="form-control" name="porcentaje" placeholder="Ingrese el porcentaje" pattern="[0-9]+" step="0.01" minlength="1" maxlength="11" required style="width: 200px; margin-right: 5px;">
                                                </div>
                                                <div class="modal-footer">
                        ...
                        <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th><center>Rangos de Margen</center></th>
                            ...
                            <tbody>
                                <?php
                                $consulta = "SELECT margen.id_margen, margen.rangos_margen, margen.porcentaje, margen.fecha_actualizacion
                                FROM margen WHERE margen.id_margen > 0";
                                ...
                                while ($fila = mysqli_fetch_array($resultado)) {
                                    ?>
                                    <tr>
                                        <td><center><?php echo $fila['rangos_margen']; ?></center></td>
                                        <td><center><?php echo $fila['porcentaje']; ?></center></td>
                                        <td><center><?php echo $fila['fecha_actualizacion']; ?></center></td>
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_margen']; ?>">
                    ...
                    <?php
                        ...
                        ?>
                        <!-- Modal Eliminar -->                   
                        <div class="modal fade" id="modalEliminar<?php echo $fila['id_margen']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content rounded-4">
                                    <div class="modal-header text-white rounded-top" style="background-color: #000DD3;">
                                        <h5 class="modal-title" id="exampleModalLabel" style="color: white; text-align: center;">¿Realmente desea quitar el rango de margen: <?php echo $fila['rangos_margen']; ?>?</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="alert alert-warning" role="alert">
                                            Si continúa, el margen sera eliminado de la base de datos.
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                            <input type="hidden" name="id_margen" value="<?php echo $fila['id_margen']; ?>">
