<?php
    ...
    if (isset($_POST['submit_crear_nuevo'])) {
        ...
        $meses_entrega = isset($_POST['meses_entrega']) && !empty($_POST['meses_entrega']) 
                 ? implode(', ', $_POST['meses_entrega']) 
                 : [];
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="tab-pane fade show active" id="clienteNuevo" role="tabpanel" aria-labelledby="clienteNuevo-tab">
                                                        ...
                                                        <input type="hidden" name="id_usuario" value="<?php echo $_GET['id_usuario']; ?>">
                                                            <div class="col"><br>
                                                                <!-- Cliente -->
                                                                <h6 class="text-center text-muted font-weight-bold bg-light p-2 rounded" style="font-family: 'Times New Roman'">Datos del Cliente</h6>
                                                                <div class="mb-2 row">
                                                                    <div class="col-sm-4">
                                                                ...
                                                                <!-- Visita -->
                                                                <h6 class="text-center text-muted font-weight-bold bg-light p-2 rounded" style="font-family: 'Times New Roman'" required>Registro de Visita</h6>
                                                                <div class="mb-2">
                                                    ...
                                                    <div class="tab-pane fade" id="clienteAntiguo" role="tabpanel" aria-labelledby="clienteAntiguo-tab">
                                                        ...
                                                        <input type="hidden" name="id_usuario" value="<?php echo $_GET['id_usuario']; ?>">
                                                            ...
                                                            <h6 class="text-center text-muted font-weight-bold bg-light p-2 rounded" style="font-family: 'Times New Roman'">Registro de Visita</h6>
                                                            <div class="mb-2">
                                                                <label class="form-label" style="color: #000000;">Elija el tipo de visita:</label>
                                                                <select name="id_tipo_visita" class="form-select" required>
                                                                    <option value="0">Seleccione una opción</option> 
