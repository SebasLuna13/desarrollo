<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $promedio_consumo = $_POST['promedio_consumo'];
    
        // Construir la consulta SQL con las variables
        $consulta = "INSERT INTO prenda (id_prenda, nombre_prenda, promedio_consumo, id_tipo_prenda)
        SELECT IFNULL(MAX(id_prenda), 0) + 1, '$nombre_prenda', '$promedio_consumo', '1'
        FROM prenda;";
        
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: prenda_suph.php");
        exit();
    }
    
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE prenda SET nombre_prenda = '$nombre_prenda', promedio_consumo = '$promedio_consumo'
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Prendas Superiores para Hombre</h1>
            </div>
            <!-- DataTable -->
                ...
                <div class="card-body">
                    <d class="row">
                                        ...
                                        <div class="modal-body">
                                            <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="nombre_prenda" placeholder="Ingresa el nombre de la prenda" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="45" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" style="color: #000000;">Ingrese el promedio de consumo:</label>
                                                    <input type="number" class="form-control" name="promedio_consumo" step="0.01" class="form-control" placeholder="Ingrese el promedio de consumo de la prenda" pattern="[0-9]+" required>
                                                </div>               
                                                <div class="modal-footer">
                        ...
                        <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th><center>Tipo de Prenda</center></th>
                                    <th><center>Promedio de Consumo</center></th>
                                    <th><center>Opciones</center></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $consulta = "SELECT prenda.id_prenda, prenda.nombre_prenda, prenda.promedio_consumo, tipo_prenda.id_tipo_prenda
                                FROM prenda LEFT JOIN tipo_prenda ON prenda.id_tipo_prenda = tipo_prenda.id_tipo_prenda
                                WHERE prenda.id_tipo_prenda = 1 ORDER BY prenda.id_prenda";
                                ...
                                while ($fila = mysqli_fetch_array($resultado)) {
                                    ?>
                                    <tr>
                                        <td><center><?php echo $fila['nombre_prenda']; ?></center></td>
                                        <td><center><?php echo $fila['promedio_consumo']; ?></center></td>
                                        <td>
                                ...
                                <div class="modal-content rounded-4">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="id_prenda" value="<?php echo $fila['id_prenda']; ?>">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" style="color: #000000;">Ingrese el promedio de consumo:</label>
                                                <input type="number" class="form-control" name="promedio_consumo" step="0.01" class="form-control" value="<?php echo $fila['promedio_consumo']; ?>" pattern="[0-9]+" required>
                                            </div>                                                         
                                            <div class="modal-footer">
