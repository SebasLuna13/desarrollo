                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th style="text-align: center; vertical-align: middle; width: 10%;">Ficha Tecnica</th>
                                            <th style="text-align: center; vertical-align: middle; width: 20%;">Cliente</th>
                                            <th style="text-align: center; vertical-align: middle; width: 17%;">Fecha Llegada <br>a Produccion</th>
                                            <th style="text-align: center; vertical-align: middle; width: 17%;">Fecha <br>de Entrega</th>
                                            <th style="text-align: center; vertical-align: middle; width: 15%;">Tipo <br> de Entrega</th>
                                            <th style="text-align: center; vertical-align: middle; width: 21%;">Opciones</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            $consulta = "SELECT cliente.nit, cliente.cliente, pedido.id_pedido, pedido.codficha_tecnica, pedido.fecha_produccion, pedido.fecha_entrega_muestra, pedido.fecha_entrega, pedido.estado, pedido.total_factura, entrega.id_entrega, entrega.tipo_entrega 
                                            FROM pedido LEFT JOIN cliente ON pedido.nit = cliente.nit LEFT JOIN entrega ON pedido.id_entrega = entrega.id_entrega WHERE pedido.estado IN ('Pedido', 'Pedido2') ORDER BY pedido.fecha_produccion DESC";
                                            $resultado = mysqli_query($enlace, $consulta);

                                            while ($fila = mysqli_fetch_array($resultado)) {
                                                // Asignar el estado del pedido a la variable $estado
                                                $estado = $fila['estado'];
                                            ?>
                                            <tr>
                                                <td class="text-center align-middle"><strong><?php echo $fila['codficha_tecnica']; ?></strong></td>
                                                ...
                                                <td class="text-center align-middle">
                                                    <?php if ($estado == 'Pedido'): ?>
                                                        <div>
                                                            <a class="btn btn-info btn-block mb-2" href="mostrar_pedidos_produccion.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>&codficha_tecnica=<?php echo $fila['codficha_tecnica']; ?>&recibido=0">
                                                                <i class="bi bi-search"></i> Prendas
                                                            </a>
                                                            <button type="button" class="btn btn-warning btn-block mb-2" data-bs-toggle="modal" data-bs-target="#modalFinalizar<?php echo $fila['id_pedido']; ?>">
                                                                <i class="bi bi-check-lg"></i> Pedido en Produccion
                                                            </button>
                                                    ...
                                                    <?php elseif ($estado == 'Pedido2'): ?>
                                                        <div>
                                                            <a class="btn btn-info btn-block mb-2" href="mostrar_pedidos_produccion2.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>&recibido=0">
                                                                <i class="bi bi-search"></i> Prendas
                                                            </a>
                                                            <button type="button" class="btn btn-warning btn-block mb-2" data-bs-toggle="modal" data-bs-target="#modalFinalizar<?php echo $fila['id_pedido']; ?>">
                                                                <i class="bi bi-check-lg"></i> Pedido en Produccion
