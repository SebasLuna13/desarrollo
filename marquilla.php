<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO marquilla (insumo, medida, id_proveedor, precio, unidades, fecha_actualizacion) 
        VALUES ('$insumo', '$medida', '$id_proveedor', '$precio', '$unidades', '$fecha_actualizacion')";
        
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: marquilla.php");
        exit();
    }
    
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE marquilla SET insumo = '$insumo', medida = '$medida', id_proveedor = '$id_proveedor', precio = '$precio', unidades = '$unidades', fecha_actualizacion = NOW()
        WHERE id_marquilla = '$id_marquilla'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: marquilla.php");
        exit();
    }
    ...
    if (isset($_POST['submit_eliminar'])) {
        $consulta = "DELETE FROM marquilla WHERE id_marquilla = '$id_marquilla'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: marquilla.php");
        exit();
    }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Tipos de Marquilla</h1>
            </div>
            <!-- DataTable -->
                ...
                <div class="card-body">
                    <d class="row">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content rounded-4">
                                        <div class="modal-header" style="background-color: #000DD3;">
                                            <h5 class="modal-title text-white" id="exampleModalLabel">Ingresa datos de la marquilla</h5>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="id_proveedor" class="form-select">
                                                            ...
                                                            <?php $consulta_mysql = 'select * from proveedor WHERE id_proveedor >= 0'; $resultado_consulta_mysql = mysqli_query($enlace, $consulta_mysql);
                        ...
                        <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $consulta = "SELECT marquilla.id_marquilla, marquilla.insumo, marquilla.medida, marquilla.precio, 
                                proveedor.id_proveedor, proveedor.nombre, marquilla.unidades, marquilla.fecha_actualizacion
                                FROM marquilla
                                LEFT JOIN proveedor ON marquilla.id_proveedor = proveedor.id_proveedor
                                WHERE marquilla.id_marquilla > 0
                                ORDER BY marquilla.id_marquilla";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_marquilla']; ?>">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_marquilla']; ?>">
                    ...
                    <?php
                        ...
                        ?>
                        <!-- Modal Editar -->
                        <div class="modal fade" id="modalEditar<?php echo $fila['id_marquilla']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content rounded-4">
                                    <div class="modal-header" style="background-color: #000DD3;">
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                        <input type="hidden" id="id_tela" name="id_marquilla" value="<?php echo $fila['id_marquilla']; ?>">
                                        <div class="mb-3">
                                                <label class="form-label" style="color: #000000;">Ingrese el nombre del insumo:</label>
                        ...
                        <!-- Modal Eliminar -->                   
                        <div class="modal fade" id="modalEliminar<?php echo $fila['id_marquilla']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content rounded-4">
                                    ...
                                    <div class="modal-footer">
                                        <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                            <input type="hidden" name="id_marquilla" value="<?php echo $fila['id_marquilla']; ?>">
