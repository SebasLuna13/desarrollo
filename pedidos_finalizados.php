    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="text-center mt-3">
                <h1 style="font-family: 'Times New Roman'">Pedidos Finalizados</h1>
            </div>
            <!-- DataTable -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a class="btn btn-info me-2" href="mostrar_finalizados_gerente.php?id_pedido=<?php echo $fila['id_pedido']; ?>&recibido=0">
